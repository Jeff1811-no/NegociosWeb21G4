...
dao_name = "BitacorasPanel" #Nombre del Dao
plural_name = "Bitacoras" #Identificador en plural
table_name = "bitacoras" #Nombre de la tabla como está en la base de datos
singular_name = "Bitacora" #Identificador en singular
####################################################################
